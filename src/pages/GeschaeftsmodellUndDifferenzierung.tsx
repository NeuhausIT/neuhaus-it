  ...
  return (
    <>
      ...
      <SubpageHero
        ...
        description="Neuhaus-IT ist ein lokal verankerter, unabhängiger IT-Dienstleister, der kleinen Unternehmen und Privathaushalten im Ruhrgebiet digitale Souveränität ermöglicht – durch Beratung, Service, Schulung und den gezielten Einsatz freier Software, Cloud-Dienste und KI-gestützter Workflows."
      ...
      <main className="container mx-auto px-4 py-16 max-w-7xl">
        ...
        <section className="mb-16">
          <p className="text-lg text-muted-foreground max-w-4xl mx-auto text-center">
            Neuhaus-IT bietet kleinen Unternehmen und Privathaushalten digitale Souveränität – durch Beratung, Service, Schulung und den gezielten Einsatz freier Software, Cloud-Dienste und KI-gestützter Workflows.
          </p>
        </section>
