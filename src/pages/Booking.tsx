...
const Booking = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <SubpageHero title="Terminbuchungen und Preise für IT-Beratung & -Service" description="Flexible Beratungsoptionen für Ihre individuellen Bedürfnisse" icon={<Calendar className="h-16 w-16 text-primary" />} />
